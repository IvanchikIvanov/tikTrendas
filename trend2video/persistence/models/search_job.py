...
from sqlalchemy import Boolean, DateTime, Float, Index, Integer, JSON, String, UniqueConstraint, text
...
class TrendSearchJobORM(Base):
    ...
    __table_args__ = (
        UniqueConstraint("name", name="uq_trend_search_jobs_name"),
        Index("ix_trend_search_jobs_is_active", "is_active"),
    )
